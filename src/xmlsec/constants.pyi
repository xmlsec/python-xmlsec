...
KeyDataName: Final = __KeyData('key-name', '(null)')
KeyDataRawX509Cert: Final = __KeyData('raw-x509-cert', 'http://www.w3.org/2000/09/xmldsig#rawX509Certificate')
KeyDataRetrievalMethod: Final = __KeyData('retrieval-method', '(null)')
...
KeyDataValue: Final = __KeyData('key-value', '(null)')
...
TransformRemoveXmlTagsC14N: Final = __Transform('remove-xml-tags-transform', '(null)', 3)
...
TransformVisa3DHack: Final = __Transform('Visa3DHackTransform', '(null)', 1)
