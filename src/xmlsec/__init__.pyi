import sys
from typing import AnyStr, Iterable, Optional, Type, TypeVar, Union
...
class Key:
    ...
    @classmethod
    def from_file(cls: Type[_K], file: _Path = ..., format: int = ..., password: Optional[str] = ...) -> _K: ...
    @classmethod
    ...
    def load_cert_from_file(self, file: _Path = ..., format: int = ...) -> None: ...
