...
def x509_issuer_serial_add_issuer_name(node: _Element = ...) -> _Element: ...
def x509_issuer_serial_add_serial_number(node: _Element = ...) -> _Element: ...
